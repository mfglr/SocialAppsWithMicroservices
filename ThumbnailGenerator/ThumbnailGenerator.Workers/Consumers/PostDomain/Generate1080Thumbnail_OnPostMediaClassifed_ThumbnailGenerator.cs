...
{
    internal class Generate1080Thumbnail_OnPostMediaClassifed_ThumbnailGenerator(ISender sender, IPublishEndpoint publishEndpoint) : IConsumer<PostMediaClassifiedEvent>
    {
