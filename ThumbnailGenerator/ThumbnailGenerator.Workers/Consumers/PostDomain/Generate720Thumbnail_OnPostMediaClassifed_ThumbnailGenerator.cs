...
{
    internal class Generate720Thumbnail_OnPostMediaClassifed_ThumbnailGenerator(ISender sender, IPublishEndpoint publishEndpoint) : IConsumer<PostMediaClassifiedEvent>
    {
