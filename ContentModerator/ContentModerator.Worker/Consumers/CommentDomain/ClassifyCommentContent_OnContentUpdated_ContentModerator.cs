...
namespace ContentModerator.Worker.Consumers.CommentDomain
{
    internal class ClassifyCommentContent_OnContentUpdated_ContentModerator(ISender sender, IPublishEndpoint publishEndpoint) : IConsumer<CommentContentUpdatedEvent>
    {
